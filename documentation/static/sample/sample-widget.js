(function() {
  // Create Parent Overlay Container for right side stacking
  let overlayContainer = document.getElementById('perceptible-overlay-container');
  if (!overlayContainer) {
    overlayContainer = document.createElement('div');
    overlayContainer.id = 'perceptible-overlay-container';
    document.body.appendChild(overlayContainer);
  }

  // Create Telemetry Widget DOM Container (Metrics)
  let widgetContainer = document.getElementById('perceptible-widget');
  if (!widgetContainer) {
    widgetContainer = document.createElement('div');
    widgetContainer.id = 'perceptible-widget';
    overlayContainer.appendChild(widgetContainer);
  }
  ...
  if (!jsonWidgetContainer) {
    ...
    overlayContainer.appendChild(jsonWidgetContainer); // stacked above telemetry widget due to flex-direction: column-reverse
  }
